...
class Spielfigur(pygame.sprite.Sprite):
    def __init__(self, initial_position, size):
        ...
        self.image = pygame.image.load('etc/Ghandi.png').convert_alpha()
...
spielfigur_2 = pygame.image.load('etc/Ghandi2.jpg').convert_alpha()
spielfigur_2_goodie = pygame.image.load('etc/Ghandi2.jpg').convert_alpha()
spielfigur_3 = pygame.image.load('etc/Ghandi2.jpg').convert_alpha()
spielfigur_3_goodie = pygame.image.load('etc/Ghandi2.jpg').convert_alpha()
spielfigur_4 = pygame.image.load('etc/Ghandi2.jpg').convert_alpha()
spielfigur_4_goodie = pygame.image.load('etc/Ghandi2.jpg').convert_alpha()
